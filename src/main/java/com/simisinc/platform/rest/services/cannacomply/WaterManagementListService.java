 ...
 */
public class WaterManagementListService {

    private static Log LOG = LogFactory.getLog(WaterManagementListService.class);
    ...
    public ServiceResponse get(ServiceContext context) {
        ...
        try {
            ...
            WaterManagementSpecification specification = new WaterManagementSpecification();
            ...
            List<WaterManagement> managementList = (List<WaterManagement>) WaterManagementRepository.query(specification).getRecords();

            ServiceResponse response = new ServiceResponse(200);
            ServiceResponseCommand.addMeta(response, "Water Management List", managementList, null);
            response.setData(managementList);
            return response;
        } catch (Exception e) {
