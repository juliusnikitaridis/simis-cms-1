...
public class UpdateComplianceUserService {

    private static Log LOG = LogFactory.getLog(UpdateComplianceUserService.class);
    ...
    public ServiceResponse post(ServiceContext context) {
        ...
        try {
            ...
            ComplianceUserRepository.update(complianceUser);

            ServiceResponse response = new ServiceResponse(200);
            ArrayList<String> responseMessage = new ArrayList<String>(){{add("Compliance User has been updated");}};
